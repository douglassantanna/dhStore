...
import {
  NewTelephoneNumber,
  ViewTelephoneNumber,
} from '../../interfaces/itelephoneNumber';
...
export class EditUserComponent implements OnInit {
  numbersTelephone: NewTelephoneNumber[] = [
    { number: '123' },
    { number: '456' },
  ];
  ...
  users: ViewUser[] = [];
  constructor(@Inject(MAT_DIALOG_DATA) public viewUser: ViewUser) {}
  ...
  addTelephone() {
    ...
    if(newTelephoneNumber.number != '')
      this.numbersTelephone.push(newTelephoneNumber);

    this.table.renderRows();
    console.log(this.numbersTelephone);
  }
  deleteTelephone() {
