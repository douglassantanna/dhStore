...
namespace api.Identity.Services
{
    ...
    public class NewUserValidation : AbstractValidator<NewUser>
    {
        ...
        {
            RuleFor(x => x.Email).NotEmpty().NotNull().WithMessage("Ops.. É necessário informar um e-mail");
            ...
            RuleFor(x => x.Role).NotEmpty().NotNull().WithMessage("Ops.. É necessário informar uma função");
